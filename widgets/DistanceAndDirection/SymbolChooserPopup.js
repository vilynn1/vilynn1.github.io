...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    baseClass: 'jimu-widget-DistanceAndDirection-symbolChooserPopup',
    ...
    postCreate: function () {
      ...
      if (this._isAndroid()) {
        this.popup.width = 355;
        domStyle.set(this.symbolChooser.domNode, 'width', '280px');
      }
    },

    /**
    * Initialize symbol chooser
    * @memberOf widgets/DD/setting/SymbolChooserPopup
    **/

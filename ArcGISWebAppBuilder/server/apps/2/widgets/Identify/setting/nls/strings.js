define({
  root: ({
    ...
    fixedPosition: "Display map info window at a fixed position on the map (i.e popup not at the identified location).",
    topPos: "Top map coordinate (in Pixels)",
    rightPos: "Right map coordinate (in Pixels)",
    identsearchresults: "Identify Search Widget Results"
  })
});

    ...
    var FeatureSetDS = declare(DataSource, {
      ...
      _getFeatureSet: function(){
        ...
        if(this.featureSet){
          ...
          queryTask.executeQueryJSON(this.url, query).then(lang.hitch(this, function(fs){
            ret.resolve(fs);
    ...
    var TableDS = declare(DataSource, {
      ...
      _getTableData: function(){
        ...
        if(this.table){
          ...
          queryTask.executeQueryJSON(this.url, query).then(lang.hitch(this, function(data){
            var table = {};

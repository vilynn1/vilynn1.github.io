...
function(declare, lang, html, _WidgetBase, topic, on, query,
  ...
  clazz = declare([_WidgetBase], {
    constructor: function(options, domId) {
      ...
      this.own(topic.subscribe("sceneViewLoaded", lang.hitch(this, this._onSceneViewLoaded)));
      this.own(topic.subscribe("sceneViewChanged", lang.hitch(this, this._onSceneViewChanged)));
      // this.own(topic.subscribe("beforeMapDestory", lang.hitch(this, this.onBeforeMapDestory)));
      this.own(topic.subscribe("beforeSceneViewDestory",
                               lang.hitch(this, this._onBeforeSceneViewDestroy)));

      this.own(topic.subscribe("builder/actionTriggered",
        lang.hitch(this, this._onActionTriggered)));
    ...
    _loadLayoutManager: function(appConfig){
      ...
      require([managerName], lang.hitch(this, function(ManagerClass){
        ...
        if (this.sceneView) {
          instance.setSceneView(this.sceneView);
        }
    ...
    _onSceneViewLoaded: function(sceneView){
      ...
      this.layoutManager.setSceneView(sceneView);
    ...
    _getFixedThemeStyles: function(theme){
      ...
      if(theme.name === 'PlateauTheme'){
        ...
        cssText += '.jimu-widget-homebutton .HomeButton .home, .jimu-widget-mylocation,' +
          ...
          ' .jimu-widget-navigate, .jimu-widget-home, .jimu-widget-compass, .jimu-widget-fullScreen,' +
          ' .jimu-widget-zoom .esri-zoom .esri-widget, .jimu-widget-placeholder' +
          '{background-color: ${mainBackgroundColor} !important;}';
    ...
    _onBeforeSceneViewDestroy: function(){

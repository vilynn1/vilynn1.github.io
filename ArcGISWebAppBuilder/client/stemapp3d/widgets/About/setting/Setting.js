...
define([
  ...
  function(
    declare, lang, html, has, query, _WidgetsInTemplateMixin, Editor, utils,
    common, BaseWidgetSetting, EditorXssFilter) {
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        var content = this.editorXssFilter.sanitize(config.about.aboutContent || this.nls.defaultContent);

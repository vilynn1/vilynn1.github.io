  ...
  function (declare, lang, array, html, aspect, query, on, keys, Deferred, Tooltip, mouse, topic,
    ...
    var clazz = declare([BaseWidget, PoolControllerMixin], {
      ...
      postMixInProperties: function () {
        ...
        this.nls.common = lang.mixin(this.nls, window.jimuNls.common);
      },
      ...
      resize: function () {
        ...
        var logoNodeFloat = html.getStyle(this.logoNodeContainer, 'float');
      ...
      _createPopupLinkNode: function () {
        ...
        var closeBtn = html.create('div', {
          ...
          role: 'button',
          'tabindex': '0',
          'aria-label': this.nls.common.close,
          style: {
            width: '30px',
            height: '30px',
            marginTop: ((this.height - 30) / 2) + 'px'
      ...
      */
      ...
      _createIconNodes: function (box, openingWidgetId) {
        ...
        // Commented to fix the issue Group widget dropdown-list does not open at runtime
        // even if being set to show in drop down menu
        // this._closeDropMenu();
      ...
      _createIconNode: function (iconConfig) {
        ...
        if (this.openedId === iconConfig.id) {
          this._addSelectedStateForIcon(node);
      ...
      _showIconContent: function (iconConfig) {
        ...
        if (iconConfig.inPanel === false) {
          this.widgetManager.loadWidget(iconConfig).then(lang.hitch(this, function (widget) {
            ...
            if(!iconNode){
              this.openedId = '';
              this._moveConfigToHeader(iconConfig);
              this._createIconNodes(html.getContentBox(this.domNode), iconConfig.id);

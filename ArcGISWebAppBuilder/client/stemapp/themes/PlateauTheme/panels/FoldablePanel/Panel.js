...
define(['dojo/_base/declare',
  ...
  function (
    declare, lang, html, array, on, keys, aspect, topic, BaseWidgetPanel,
    ...
    return declare([BaseWidgetPanel, FoldableDijit], {
      ...
      startup: function () {
        ...
        //Set role attribute to widget dom node
      ...
      */
      ...
      createMaxBtn: function () {
        ...
        //Add keydown event on max node
        //If ENTER key is press, proceed with node click event
        //IF ESC key is press, set focus to widget icon in the application header
        this.own(on(this.maxNode, 'keydown', lang.hitch(this, function (evt) {
          ...
          if (evt.keyCode === keys.ESCAPE) {
            evt.stopPropagation();
            var node = query(".jimu-state-selected")[0];
            if (node) {
              node.focus();
            }
          }

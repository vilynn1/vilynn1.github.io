define({
  root: ({
    ...
    ChartSetting: {
      ...
      lineChart: "Line chart", // shown as a label for line chart radio button
      dataSeriesField: "Data series field", // shown as a label for selecting data series set.
      lineDataSeriesField: "Value field", // shown as a label for line chart data series field
      labelField: "Label field", // shown as a label for selecting label field set.
      lineLabelSeriesField: "Sequence field", // shown as a label for selecting label field set.
      ...
      errMsgFieldByValue: "Please select color by field value", // shown as an error in alert box if color by field value is empty.
      errMsgDataSeriesField: "Please select value field", // shown as an error in alert box if value field value is empty.
      ...
      setValueFields: "Set Value Fields", // Shown as a title for selecting value fields for line chart
      layoutSeriesLabel: "Series", // Show as legend label  in line chart
    ...
    searchSourceSetting: {
      ...
      maxSuggestionErrorMessage: "Please enter valid maximum suggestions value. The value is out of range or invalid.", // Displayed as a error message when input value is invalid/out-of-range for this parameter.
      maxResultsErrorMessage: "Please enter valid maximum results value. The value is out of range or invalid.", // Displayed as a error message when input value is invalid/out-of-range for this parameter.
      zoomScaleErrorMessage: "Please enter valid zoom scale value. The value is out of range or invalid.", // Displayed as a error message when input value is invalid/out-of-range for this parameter.
      minScaleErrorMessage: "Please enter valid min scale value. The value is out of range or invalid.", // Displayed as a error message when input value is invalid/out-of-range for this parameter.
      radiusErrorMessage: "Please enter valid radius value. The value is out of range or invalid." // Displayed as a error message when input value is invalid/out-of-range for this parameter.
    }
  }),
  "ar": 1,
  "bg": 1,

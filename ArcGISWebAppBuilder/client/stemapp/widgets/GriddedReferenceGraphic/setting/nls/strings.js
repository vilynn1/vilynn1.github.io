define({
  root: ({
    ...
    "selectOpLayerLabel": "Operational layer for results", // Label for the operational layer drop-down list,
    ...
    // Lock Settings
    "lockSettings": "Lock Settings - This will prevent the user from being able to change any of the configured settings within the widget" // Shown as description next to lock settings toggle
  }),
  "ar": 1,
  "bg": 1,
  "bs": 1,

define({
  root: ({
    ...
    "defineGridFromAreaDesc": "Create grids by defining the area by dimension or by reference system", // Description for Define Grid from an Area
    "defineGridFromAreaDimensionDesc": "Create a grid from a user-defined extent and a specified cell width and height, or number of horizontal and vertical cells", // Description for Define a grid from an area by dimension
    "defineGridFromaAreaRefSystemDesc": "Create a grid from a user-defined extent, based on a reference system", // Description for Define a grid from an area by reference system
    "defineGridFromPointDesc": "Use a point to create grids defined from a point by dimension, reference system, or time and speed", // Description for Define a grid from a point
    "defineGridFromPointByDimensionDesc": "Create a grid from a user-defined point, either manually input or interactively selected, based on a number of horizontal and vertical cells and cell width and height", // Description for Define a grid from a point by dimension
    "defineGridFromPointByRefSystemDesc": "Create a grid from a user-defined point, either manually input or interactively selected, based on a reference system", // Description for define a grid from a point by reference system
    "defineGridFromPointTimeSpeedDesc": "Create a grid from a user-defined point, either manually input or interactively selected, based on time and speed", // Description for Define a grid from a point by time and speed
    ...
    "gridSettings": {
      ...
      "UTM": "UTM", // Shown as label for UTM in reference system dropdown
      "showLabels": "Show Labels", // Shown as label for show labels toggle switch
      "colorPicker": "Color Picker", // read as aria label for color picker
      "bold": "Bold", // read as aria label for bold,
      "italic": "Italic", // read as aria label for bold
      "underline": "Underline" // read as aria label for bold
    },
    ...
    "publishWorskpaceError": "ERROR: Error in opening workspace", //Shown when publishing to Portal with PKI authentication
    ...
    "coordInputLabel": "GRG Origin", // Shown as label for coordinate input box (DD) denotes that decimal degrees is set as the default
    ...
    "projectionNotSupported": "Your browser does not support WebAssembly. The support for WebAssembly is required since this widget uses the client-side projection engine to create GRGs", // Shown as message on widget launch when projection is not supported at client side
    ...
    "deleteBtn": "Delete", //delete button for right-click context menu

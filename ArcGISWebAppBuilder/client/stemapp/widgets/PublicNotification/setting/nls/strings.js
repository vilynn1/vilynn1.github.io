...
define({
  root: ({
    ...
    hints: {  // Explanations of configuration items
      ...
      reviewButtonHint: "Allows users to review final selection on the selected addressee layer"
    },
    propertyLabels: {  // Labels for individual property items
      ...
      addCSVHeader: "Add column title (for CSV only)",
      zoomScale: "Zoom scale",
      reviewCheckboxLabel: "Show review button in the widget"
    },
    buttons: {
    ...
    placeholders: {  // Text shown in individual property items to provide an example of content
      ...
      descriptionCSV: "Comma-separated values (CSV)",
    ...
    problems: {
      ...
      noSearchSourcesConfigured: "Please configure at least one search source",
      noSearchSourceFeaureLayerConfigured: 'Please configure at least one feature layer as a search source for using selection drawing tools'
    },
    querySourceSetting: {
      ...
      setGeocoderURL: "Set Geocoder URL",
      locatorError: "Locator must support single line locating.",
      invalidUrlTip: "The URL ${URL} is invalid or inaccessible."
    }
  }),
  "ar": 1,

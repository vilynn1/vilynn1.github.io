define({
  root: ({
    ...
    labels: {
      ...
      uploadHeading: "Upload a settings file",
      saveHeading: "Save current settings",
      saveHint: "Save the current filter settings to a file. Upload the file below to retrieve these settings later.",
      layerOptionHeading: "Filter options",
      AppendDefHeading: "Append to Existing Definitions Using",
      PersistDefHeading: "Persist filters after the widget is closed",
      RefreshValueList: "Pulls data changes to refresh the list of values in the filter drop-down.",
      RefreshButton: "Refresh",
      RefreshHeading: "Refresh data",
      operatorLabel: "Select an operator"
    },
    buttons: {
      save: "Save",

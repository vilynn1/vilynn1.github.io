...
define({
  ...
  "traverseSettings": {
    ...
    "addButtonTitle": "إضافة",
    "deleteButtonTitle": "إزالة",
    "deleteBearingAndLengthLabel": "إزالة صف الطول والاتجاه الزاوي",
    "addButtonLabel": "إضافة اتجاه زاوي وطول"
  },
  "planSettings": {
  ...
  "reportsTab": {
    ...
    "uploadShapefileForAnalysisText": "تحميل ملف الشكل لتضمينه في التحليل",
    ...
    "analysisAreaUnitLabelText": "عرض نتائج المنطقة في:",
    "analysisLengthUnitLabelText": "عرض كل نتائج الطول في:",
    ...
    "hectaresAbbr": "هيكتار",
    "squareMilesAbbr": "أميال مربعة",
    "layerNotVisibleText": "يتعذر التحليل. إيقاف تشغيل الطبقة أو أنها خارج مقياس نطاق الرؤية.",
    ...
    "errorInLoadingProjectionModule": "حدث خطأ أثناء تحميل تبعيات الوحدة النمطية للمشروع. يرجى إعادة محاولة تنزيل الملف.",
    "expandCollapseIconLabel": "المعالم المتقاطعة",

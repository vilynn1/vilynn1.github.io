...
define({
  ...
  "drawToolWidget": {
    ...
    "chooseLayerTitle": "Επιλογή επιλέξιμων θεματικών επιπέδων",
    ...
    "selectToolLabel": "Επιλογή εργαλείου"
  },
  "shapefileWidget": {
    "shapefileLabel": "Αποστολή συμπιεσμένου shapefile",
    "uploadShapefileButtonText": "Μεταφόρτωση",
    "unableToUploadShapefileMessage": "Δεν είναι δυνατή η μεταφόρτωση του shapefile."
  },
  "coordinatesWidget": {
  ...
  "traverseSettings": {
    ...
    "addButtonTitle": "Προσθήκη",
    "deleteButtonTitle": "Κατάργηση",
    "deleteBearingAndLengthLabel": "Κατάργηση διόπτευσης και γραμμής μήκους",
    "addButtonLabel": "Προσθήκη διόπτευσης και μήκους"
  },
  "planSettings": {
  ...
  "reportsTab": {
    ...
    "uploadShapefileForAnalysisText": "Μεταφόρτωση του shapefile για συμπερίληψη στην ανάλυση",
    ...
    "unableToDownloadFileGDBText": "Δεν είναι δυνατή η λήψη file geodatabase για AOI που περιέχει σημειακές ή γραμμικές τοποθεσίες.",
    "unableToDownloadShapefileText": "Δεν είναι δυνατή η λήψη Shapefile για την AOI που περιέχει τοποθεσίες σημείου ή γραμμής",
    "analysisAreaUnitLabelText": "Εμφάνιση αποτελεσμάτων εμβαδού σε:",
    "analysisLengthUnitLabelText": "Εμφάνιση αποτελεσμάτων μήκους σε:",
    ...
    "squareMilesAbbr": "Τετραγωνικά μίλια",
    "layerNotVisibleText": "Δεν είναι δυνατή η ανάλυση. Το θεματικό επίπεδο είναι απενεργοποιημένο ή εκτός εύρους κλίμακας ορατότητας.",
    ...
    "errorInLoadingProjectionModule": "Σφάλμα κατά τη φόρτωση των εξαρτήσεων της μονάδας προβολής. Προσπαθήστε να επαναλάβετε τη λήψη του αρχείου.",
    "expandCollapseIconLabel": "Τεμνόμενα στοιχεία",

...
define({
  ...
  "traverseSettings": {
    ...
    "addButtonTitle": "הוספה",
    "deleteButtonTitle": "הסר",
    "deleteBearingAndLengthLabel": "הסר את שורת הכיוון והאורך",
    "addButtonLabel": "הוסף כיוון ואורך"
  },
  "planSettings": {
  ...
  "reportsTab": {
    ...
    "uploadShapefileForAnalysisText": "העלה Shapefile שייכלל בניתוח",
    ...
    "analysisAreaUnitLabelText": "הצג את תוצאות השטח ב:",
    "analysisLengthUnitLabelText": "הצג את תוצאות האורך ב:",
    ...
    "errorInLoadingProjectionModule": "שגיאה בעת טעינת יחסי תלות של מודול ההיטל. נסה להוריד את הקובץ שוב.",
    "expandCollapseIconLabel": "ישויות מצטלבות",

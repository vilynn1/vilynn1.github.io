...
define({
  ...
  "traverseSettings": {
    ...
    "addButtonTitle": "추가",
    "deleteButtonTitle": "제거",
    "deleteBearingAndLengthLabel": "방향 및 길이 행 제거",
    "addButtonLabel": "방향 및 길이 추가"
  },
  "planSettings": {
  ...
  "reportsTab": {
    ...
    "analysisAreaUnitLabelText": "영역 결과 표시 단위:",
    "analysisLengthUnitLabelText": "길이 결과 표시 단위:",
    ...
    "layerNotVisibleText": "분석할 수 없습니다. 레이어가 꺼져 있거나 축척 가시성 범위를 벗어났습니다.",
    ...
    "errorInLoadingProjectionModule": "투영 모듈의 접근성을 불러오는 중 오류가 발생했습니다. 파일을 다시 다운로드해 보세요.",
    "expandCollapseIconLabel": "교차된 피처",

define({
  root: ({
    ...
    inputRecordBy: "Input record by",
    renderer: "Renderer",
    displayType: "Display type",
    helpUrl: "Help URL",
    useResultMapService: "View result with a map service",
    drawOnMap: "Interactively draw on the map",
    selectLayer: "Select a layer from the map",
    selectTable: "Select a table from the map",
    ...
    inputJSONString: "Input JSON string",
    useFeatureCollection: "Do not send URL but FeatureCollections as input."
  }),
  "ar": 1,
  "bg": 1,
  "bs": 1,

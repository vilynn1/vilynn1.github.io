...
function (array, when, esriRequest, GeocodeUtil, webMercatorUtils, FileUtil, portalUtils) {
    ...
    var countryHierarchies = {};
    var countryDisableMultiHierarchySupport = {};
    ...
    return {
            ...
            return portal.loadSelfInfo().then(function (portalSelf) {
                ...
                return esriRequest({
                  ...
                  array.forEach(response.countries, function (country) {
                    ...
                    array.forEach(country.hierarchies, function(hierarchy) {
                      if (hierarchy.default) {
                        countryHierarchies[country.id] = hierarchy.ID;
                      }
                    });

                    // Disable Multi Hierarchy Support (used by USA and Puerto Rico)
                    countryDisableMultiHierarchySupport[country.id] = !!country.disableMultiHierarchySupport;
                  });
        ...
        */
        ...
        getCountryHierarchies: function() {
          return countryHierarchies;
        },

        getCountryDisableMultiHierarchySupport: function() {
          return countryDisableMultiHierarchySupport;
        }
    };
});

  ...
  return declare([_WidgetBase, _TemplatedMixin, _WizardPage, _WidgetsInTemplateMixin], {
    ...
    runInfographic: function () {
      ...
      this.reportPlayer = new ReportPlayer({
        ...
        config: {
          esriDijitCssUrl: "https://js.arcgis.com/3.37/dijit/themes/claro/claro.css",
          esriCssUrl: "https://js.arcgis.com/3.37/esri/css/esri.css",
          playerSourceRootUrl: "https://js.arcgis.com/3.37/"
        },
        onClose: function () {
      ...
      var runPlayer = function (reportID) {
        ...
        self.reportPlayer.playReport({
          ...
          reportID: reportID,
          reverseAnalysisAreasOnMap: true,

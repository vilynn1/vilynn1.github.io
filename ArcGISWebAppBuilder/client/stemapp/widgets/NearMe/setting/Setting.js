...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    **/
    _initTabs: function () {
      var layerSettingTab, routeSettingTab, searchSourceSettingTab, symbologySettingTab,
        filterSettingTab, tabs;
      ...
      tabs = [searchSourceSettingTab, layerSettingTab, routeSettingTab,
        symbologySettingTab, filterSettingTab];
    ...
    **/
    getConfig: function () {
      ...
      this.config = {
        ...
        "defaultBufferDistance": this.defaultBufferDistanceNode.value,
        ...
        "showAllLayers": this.showAllLayersNode.getValue(),
    ...
    **/
    setConfig: function () {
      ...
      if (this.config) {
        ...
        // check if user wants see features without consideirng its layer visibility
        if (this.config.showAllLayers) {
          this.showAllLayersNode.setValue(this.config.showAllLayers);
        }

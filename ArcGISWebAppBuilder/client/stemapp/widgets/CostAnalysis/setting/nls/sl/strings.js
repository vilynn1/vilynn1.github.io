...
define({
  ...
  "generalSettings": {
    ...
    "measurementUnitLabel": "Enota stroška",
    "currencyLabel": "Simbol stroška",
    ...
    "csvReportExportLabel": "Omogoči uporabniku izvoz poročila projekta",
    "editReportSettingsBtnTooltip": "Uredi nastavitve poročila",
    "roundCostValues": {
    ...
    "reportSettings": {
      "reportSettingsPopupTitle": "Nastavitve poročila",
      "reportNameLabel": "Ime poročila (izbirno) :",
      "checkboxLabel": "Prikaži",
      "layerTitle": "ime",
      "columnLabel": "Napis",
      "duplicateMsg": "Podvojeni napisi"
    },
    "projectAreaType": {
      "outline": "Obroba",
      "buffer": "Obris"
  ...
  "projectSettings": {
    ...
    "fieldToLabelGeographyHelp": "<p>Besedilna in številska polja izbranega stroškovnega geometrijskega sloja bodo prikazana v spustnem meniju Polje v Napis lokacije.</p>",
    "projectAssetsTableHelp": "<p>Prikazane bodo tabele z naslednjimi pogoji: <br/> <li>Tabele morajo imeti zmožnost urejanja, in sicer \"Ustvari\", \"Izbriši\" in \"Posodobi\".</li> <li>Tabela mora imeti šest polj s točnimi imeni in tipi podatkov:</li><ul><li> AssetGUID (tip polja GUID)</li><li> CostEquation (tip polja z besedilom)</li><li> Scenarij (tip polja z besedilom)</li><li> TemplateName (tip polja z besedilom)</li><li> GeographyGUID (tip polja GUID)</li><li> ProjectGUID (tip polja GUID)</ul></li> </p>",
    ...
    "projectLayerHelp": "<p>Prikazani bodo poligonski sloji z naslednjimi pogoji: <br/> <li>Sloj mora imeti zmožnosti urejanja, in sicer \"Ustvari\", \"Izbriši\" in \"Posodobi\".</li> <li>Sloji morajo imeti pet polj s točnimi imeni in tipi podatkov:</li><ul><li>ProjectName (tip polja z besedilom)</li><li>Opis (tip polja z besedilom)</li><li>Skupni strošek sredstva (tip polja decimalno enojno/dvojno)</li><li>Bruto strošek projekta (tip polja enojno/dvojno)</li><li>GlobalID (tip polja GlobalID)</li></ul> </p>",
    "pointLayerCentroidLabel": "Centroid točkovnega sloja",
    "selectRelatedPointLayerDefaultOption": "Izberi",
    "pointLayerHintText": "<p>Prikazani bodo točkovni sloji z naslednjimi pogoji: <br/> <li>\tSloj mora imeti polje »Id projekta« (vrste GUiD).</li><li>\tSloj mora imeti zmožnosti urejanja, tj. »Ustvari«, »Izbriši« in »Posodobi«.</li></p>"
  },
  "layerSettings": {
    ...
    "create": "Ustvari",
    "update": "Posodobi",
    "deleteColumnLabel": "Zbriši",
    "attributeSettingHeaderTitle": "Nastavitve atributa",
    "addFieldLabelTitle": "Dodaj atribute",
    "layerAttributesHeaderTitle": "Sloj atributa",
    "projectLayerAttributesHeaderTitle": "Atributi sloja projekta",
    "attributeSettingsPopupTitle": "Nastavitve atributa sloja"
  },
  "costingInfo": {
    ...
    "noLayerMessage": "Vnesite vsaj eno sloj v ${tabName}",
    "noEditableLayersAvailable": "Sloji morajo biti označeni kot uredljivi v zavihku nastavitev sloja",
    "updateProjectCostCheckboxLabel": "Posodobitev enačb projekta",
    "updateProjectCostEquationHint": "Namig: to bo uporabniku omogočilo, da posodobi enačbe stroškov za sredstva, ki so že dodana v obstoječe projekte z novimi enačbami, ki so določene spodaj na osnovi predloge geoobjekta, prostorskega nivoja in scenarija. Če kombinacije ni mogoče najti, bo nastavljena na privzeto enačbo stroškov, tj. prostorski nivo in scenarij bosta označena z »Brez«. V primeru odstranjene predloge geoobjekta bodo stroški nastavljeni na 0."
  },
  "statisticsSettings": {
    "tabTitle": "Dodatne nastavitve",
  ...
  "projectCostSettings": {
    "addProjectCostLabel": "Dodaj dodatne stroške projekta",
    "additionalCostValueColumnHeader": "Vrednost",
    "invalidProjectCostMessage": "Neveljaven vnos za stroške projekta",
    "additionalCostLabelColumnHeader": "Napis",

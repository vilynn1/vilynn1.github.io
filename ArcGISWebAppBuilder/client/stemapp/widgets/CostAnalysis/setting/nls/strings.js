...
define({
	root: ({
		...
		generalSettings: {
			...
			measurementUnitLabel: "Cost Unit",
			currencyLabel: "Cost Symbol",
			...
			csvReportExportLabel: "Allow user to export report of the project",
			editReportSettingsBtnTooltip : "Edit report settings",
			roundCostValues: {
			...
			reportSettings: {
				reportSettingsPopupTitle: "Report Settings",
				reportNameLabel:"Report name (optional) :",
				checkboxLabel : "Show",
				layerTitle : "Title",
				columnLabel : "Label",
				duplicateMsg: "Duplicate label"
			},
			projectAreaType: {
				outline: "Outline",
				buffer: "Buffer"
		...
		projectSettings: {
			...
			pointLayerCentroidLabel: "Point Layer Centroid",
			selectRelatedPointLayerDefaultOption: 'Select',
			pointLayerHintText: "<p>Point layer(s) with following conditions will be shown: <br/> <li>	Layer must have 'Projectid' (GUID type) field</li><li>	Layer must have editing capabilities namely 'Create', 'Delete' and 'Update'</li></p>"
		},
		layerSettings: {
			...
			create: "Create",
			update: "Update",
			deleteColumnLabel: "Delete",
			attributeSettingHeaderTitle: "Attribute Settings",
			addFieldLabelTitle: "Add Attributes",
			layerAttributesHeaderTitle: "Layer Attributes",
			projectLayerAttributesHeaderTitle: "Project Layer Attributes",
			attributeSettingsPopupTitle: "Layer Attribute Settings"
		},
		costingInfo: {
			...
			noTemplateAvailable: "Please add at least one template for ${layerName}",
			manageScenarioLabel: "Manage scenario",
			noLayerMessage: "Please enter at least one layer in ${tabName}",
			noEditableLayersAvailable: "Layer(s) needs to be checked as editable in layer settings tab",
			updateProjectCostCheckboxLabel:	"Update project equations",
			updateProjectCostEquationHint:	"Hint: This will allow user to update cost equations of assets already added in existing projects with the new equations defined below based on the feature template, geography and scenario. If the combination is not found, it will be set to default cost equation i.e. geography and scenario as 'None'. In case of removed feature template, cost will be set as 0."
		},
		statisticsSettings: {
			tabTitle: "Additional settings",
		...
		projectCostSettings: {
			addProjectCostLabel: "Add Additional Project Cost",
			additionalCostValueColumnHeader: "Value",
			invalidProjectCostMessage: "Invalid Entry for project cost",

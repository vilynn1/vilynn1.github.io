...
define({
  ...
  "projectSettings": {
    ...
    "projectLayerHelp": "<p>Es mostraran les capes de polígon amb les condicions següents: <br/> <li>La capa ha de tenir funcions d'edició, com ara \"Crea, \"Suprimeix\" i \"Actualitza\"</li> <li>La capa ha de tenir cinc camps amb el nom i el tipus de dades exactes:</li><ul><li>ProjectName (camp de tipus cadena)</li><li>Description (camp de tipus cadena)</li><li>Totalassetcost (camp de tipus valor flotant o doble)</li><li>Grossprojectcost (camp de tipus valor flotant o doble)</li><li>GlobalID (camp de tipus GlobalID)</li></ul> </p>",

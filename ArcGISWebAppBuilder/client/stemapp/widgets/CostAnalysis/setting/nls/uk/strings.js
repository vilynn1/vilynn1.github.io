...
define({
  ...
  "generalSettings": {
    ...
    "measurementUnitLabel": "Одиниця витрат",
    "currencyLabel": "Символ витрат",
    ...
    "csvReportExportLabel": "Дозволити користувачу експортувати звіт з проекту",
    "editReportSettingsBtnTooltip": "Редагування налаштувань звіту",
    "roundCostValues": {
    ...
    "reportSettings": {
      "reportSettingsPopupTitle": "Налаштування звіту",
      "reportNameLabel": "Назва звіту (необов’язково):",
      "checkboxLabel": "Показати",
      "layerTitle": "Заголовок",
      "columnLabel": "Напис",
      "duplicateMsg": "Повторити напис"
    },
    "projectAreaType": {
      "outline": "Контур",
      "buffer": "Буфер"
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Буде показано полігональні шари з наступними умовами: <br/> <li> Шар повинен мати можливість «Запит»</li><li> Шар повинен мати поле GlobalID</li></p>",
    ...
    "projectAssetsTableHelp": "<p>Буде показано таблиці з наступними умовами: <br/> <li>Таблиця повинна мати можливості редагування, а саме «Створити», «Видалити» й «Оновити»</li> <li>Таблиця повинна мати шість полів з точним іменем і типом даних:</li><ul><li> GUIDАктиву (поле типу GUID )</li><li> Рівняння вартості (поле рядкового типу)</li><li> Сценарій (поле рядкового типу)</li><li> Ім'яШаблону (поле рядкового типу)</li><li> GUIDГеографії (поле типу GUID)</li><li> GUIDПроекту (поле типу GUID)</li></ul> </p>",
    "projectMultiplierTableHelp": "<p>Буде показано таблиці з наступними умовами: <br/> <li>Таблиця повинна мати можливості редагування, а саме «Створити», «Видалити» й «Оновити»</li> <li>Таблиця повинна мати п'ять полів з точним іменем і типом даних:</li><ul><li> Опис (поле рядкового типу)</li><li> Тип (поле рядкового типу)</li><li> Значення (поле плаваючого/подвійного типу)</li><li> ІндексВартості (поле цілого числа)</li><li> GUIDПроекту (поле типу GUID)</li></ul> </p>",
    "projectLayerHelp": "<p>Буде показано полігональні шари з наступними умовами: <br/> <li>Шар повинен мати можливості редагування, а саме «Створити», «Видалити» й «Оновити»</li> <li>Шар повинен мати п'ять полів з точним іменем і типом даних:</li><ul><li>Ім'я проекту (поле рядкового типу)</li><li>Опис (поле рядкового типу)</li><li>ЗагальнаВартістьАктиву (поле плаваючого/подвійног типу)</li><li>ВаловаВартістьПроекту (поле плаваючого/подвійного типу)</li><li>GlobalID (поле типу GlobalID)</li></ul> </p>",

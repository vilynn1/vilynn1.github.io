...
define({
  ...
  "generalSettings": {
    "tabTitle": "一般設定",
    "measurementUnitLabel": "成本單位",
    "currencyLabel": "成本符號",
    "roundCostLabel": "回合成本",
    "projectOutputSettings": "專案輸出設定",
    "typeOfProjectAreaLabel": "專案區域的類型",
    "bufferDistanceLabel": "緩衝距離",
    "csvReportExportLabel": "允許使用者匯出專案的報告",
    "editReportSettingsBtnTooltip": "編輯報告設定",
    "roundCostValues": {
    ...
    "reportSettings": {
      "reportSettingsPopupTitle": "報告設定",
      "reportNameLabel": "報告名稱 (選用):",
      "checkboxLabel": "顯示",
      "layerTitle": "標題",
      "columnLabel": "標籤",
      "duplicateMsg": "重複的標籤"
  ...
  "projectSettings": {
    ...
    "pointLayerCentroidLabel": "點圖層質心",
    "selectRelatedPointLayerDefaultOption": "選擇",
    "pointLayerHintText": "<p>將顯示包含下列條件的點圖層: <br/> <li>\t圖層必須具有「Projectid」(GUID 類型) 欄位</li><li>\t圖層必須具有名為「建立」、「刪除」和「更新」的編輯功能</li></p>"
  },
  "layerSettings": {
    "tabTitle": "圖層設定",
    ...
    "create": "建立",
    "update": "更新",
    "deleteColumnLabel": "刪除",
    "attributeSettingHeaderTitle": "屬性設定",
    "addFieldLabelTitle": "新增屬性",
    "layerAttributesHeaderTitle": "圖層屬性",
    "projectLayerAttributesHeaderTitle": "專案圖層屬性",
    "attributeSettingsPopupTitle": "圖層屬性設定"
  },
  "costingInfo": {
    "tabTitle": "成本資訊",
    ...
    "updateProjectCostCheckboxLabel": "更新專案方程式",
    "updateProjectCostEquationHint": "提示: 這將允許使用者根據圖徵樣板、地理和案例，使用下列定義的新方程式來更新現有專案中已新增之資產的更新成本方程式。 如果找不到組合，則會將其設為預設的成本方程式，例如將地理和案例設為「無」。 若已移除圖徵樣板，會將成本設為 0。"
  },
  "statisticsSettings": {
    "tabTitle": "其他設定",
  ...
  "projectCostSettings": {
    "addProjectCostLabel": "新增其他專案成本",
    "additionalCostValueColumnHeader": "數值",
    "invalidProjectCostMessage": "專案成本的項目無效",
    "additionalCostLabelColumnHeader": "標籤",
    "additionalCostTypeColumnHeader": "類型"
  },
  "statisticsType": {
    "countLabel": "計數",
    "averageLabel": "平均值",

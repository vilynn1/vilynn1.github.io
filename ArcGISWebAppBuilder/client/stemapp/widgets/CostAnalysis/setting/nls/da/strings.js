...
define({
  ...
  "generalSettings": {
    ...
    "measurementUnitLabel": "Omkostningsenhed",
    "currencyLabel": "Omkostningssymbol",
    ...
    "csvReportExportLabel": "Tillad brugeren af eksportere rapport for projektet",
    "editReportSettingsBtnTooltip": "Rediger rapport-indstillinger",
    "roundCostValues": {
    ...
    "reportSettings": {
      "reportSettingsPopupTitle": "Rapportindstillinger",
      "reportNameLabel": "Rapportnavn (valgfrit):",
      "checkboxLabel": "Vis",
      "layerTitle": "Titel",
      "columnLabel": "Mærke",
      "duplicateMsg": "Dobbeltforekomst af etiketter"
    },
    "projectAreaType": {
      "outline": "Kontur",
      "buffer": "Buffer"
  ...
  "projectSettings": {
    ...
    "fieldToLabelGeographyHelp": "<p>Strengen og de numeriske felter for det valgte 'Omkostningsgeometrilag' vil blive vist i rullemenuen 'Feltetiket-geografi'.</p>",
    ...
    "pointLayerCentroidLabel": "Punktlag-centroid",
    "selectRelatedPointLayerDefaultOption": "Vælg",
    "pointLayerHintText": "<p>Punktlag med følgende betingelser vil blive vist: <br/> <li>\tLaget skal indeholde feltet 'Projectid' (GUID-type)</li><li>\tLaget skal have redigeringsfunktioner, nemlig 'Opret', 'Slet' og 'Opdatér'</li></p>"
  },
  "layerSettings": {
    ...
    "create": "Opret",
    "update": "Opdatering",
    "deleteColumnLabel": "Slet",
    "attributeSettingHeaderTitle": "Attributindstillinger",
    "addFieldLabelTitle": "Tilføj attributter",
    "layerAttributesHeaderTitle": "Lag-attributter",
    "projectLayerAttributesHeaderTitle": "Projektlag-attributter",
    "attributeSettingsPopupTitle": "Indstillinger for lag-attributter"
  },
  "costingInfo": {
    ...
    "updateProjectCostCheckboxLabel": "Opdatér projektligninger",
    "updateProjectCostEquationHint": "Tip: Dette vil gøre det muligt for brugeren at opdatere omkostningsligninger for aktiver, der allerede er blevet føjet til eksisterende projekter med de nye ligninger, der er defineret nedenfor baseret på objektskabelon, geografi og scenarie. Hvis denne kombination ikke findes, vil den blive indstillet til standardomkostningsligningen, dvs. geografi og scenarie er indstillet til 'None'. Hvis objektskabelonen er blevet fjernet, vil omkostningen blive angivet til 0."
  },
  "statisticsSettings": {
    "tabTitle": "Flere indstillinger",
  ...
  "projectCostSettings": {
    "addProjectCostLabel": "Tilføj yderligere projektomkostninger",
    "additionalCostValueColumnHeader": "Værdi",
    "invalidProjectCostMessage": "Ugyldig angivelse af projektomkostning",
    "additionalCostLabelColumnHeader": "Mærke",

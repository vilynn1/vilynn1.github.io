...
define({
  ...
  "generalSettings": {
    ...
    "measurementUnitLabel": "Unit Biaya",
    "currencyLabel": "Simbol Biaya",
    ...
    "csvReportExportLabel": "Izinkan pengguna untuk mengekspor laporan proyek",
    "editReportSettingsBtnTooltip": "Edit pengaturan laporan",
    "roundCostValues": {
    ...
    "reportSettings": {
      "reportSettingsPopupTitle": "Pengaturan Laporan",
      "reportNameLabel": "Nama laporan (opsional):",
      "checkboxLabel": "Tampilkan",
      "layerTitle": "Judul",
      "columnLabel": "Label",
      "duplicateMsg": "Duplikasi label"
    },
    "projectAreaType": {
      "outline": "Kerangka",
      "buffer": "Buffer"
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Layer poligon dengan kondisi berikut akan ditampilkan:<br/> <li> Layer harus memiliki kemampuan 'Kueri' </li><li> Layer harus memiliki kolom GlobalID</li></p>",
    "fieldToLabelGeographyHelp": "<p>Kolom string dan numerik 'Layer Geometri Penetapan Biaya' yang dipilih akan ditampilkan di menu tarik-turun 'Kolom untuk Melabeli Geometri'.</p>",
    "projectAssetsTableHelp": "<p>Tabel dengan ketentuan berikut akan ditampilkan: <br/> <li>Tabel harus memiliki kemampuan pengeditan yaitu 'Buat', 'Hapus', dan 'Perbarui'</li> <li>Tabel harus memiliki enam kolom dengan nama dan tipe data yang tepat:</li><ul><li> AssetGUID (Kolom tipe GUID)</li><li> CostEquation (Kolom tipe string)</li><li> Skenario (Kolom tipe string)</li><li> TemplateName (Kolom tipe string)</li><li> GeographyGUID (Kolom tipe GUID)</li><li> ProjectGUID (Kolom tipe GUID)</li></ul> </p>",
    "projectMultiplierTableHelp": "<p>Tabel dengan ketentuan berikut akan ditampilkan: <br/> <li>Tabel harus memiliki kemampuan pengeditan yaitu 'Buat', 'Hapus', dan 'Perbarui'</li> <li>Tabel harus memiliki lima kolom dengan nama dan tipe data yang tepat:</li><ul><li> Deskripsi (Kolom tipe string)</li><li> Tipe (Kolom tipe string)</li><li> Nilai (Kolom tipe Float/Double)</li><li> Costindex (Kolom tipe bilangan bulat)</li><li> ProjectGUID (Kolom tipe GUID))</li></ul> </p>",
    "projectLayerHelp": "<p>Layer poligon dengan ketentuan berikut akan ditampilkan: <br/> <li>Layer harus memiliki kemampuan pengeditan yaitu 'Buat', 'Hapus', dan 'Perbarui'</li> <li>Layer harus memiliki lima kolom dengan nama dan tipe data tepat:</li><ul><li>ProjectName (Kolom tipe string)</li><li>Deskripsi (Kolom tipe string)</li><li>Totalassetcost (Kolom tipe Float/Double)</li><li>Grossprojectcost (Kolom tipe Float/Double)</li><li>GlobalID (Kolom tipe GlobalID)</li></ul> </p>",
    "pointLayerCentroidLabel": "Centroid Layer Titik",
    "selectRelatedPointLayerDefaultOption": "Pilih",
    "pointLayerHintText": "<p>Layer titik dengan syarat berikut akan ditampilkan: <br/> <li>\tLayer harus memiliki kolom 'Projectid' (jenis GUID)</li><li>\tLayer harus memiliki kemampuan pengeditan, yaitu 'Buat', 'Hapus', dan 'Perbarui'</li><p/>"
  },
  "layerSettings": {
    ...
    "create": "Buat",
    "update": "Perbarui",
    "deleteColumnLabel": "Hapus",
    "attributeSettingHeaderTitle": "Pengaturan Atribut",
    "addFieldLabelTitle": "Tambah Atribut",
    "layerAttributesHeaderTitle": "Atribut Layer",
    "projectLayerAttributesHeaderTitle": "Atribut Layer Proyek",
    "attributeSettingsPopupTitle": "Pengaturan Atribut Layer"
  },
  "costingInfo": {
    ...
    "noTemplateAvailable": "Harap tambahkan setidaknya satu template untuk ${layerName}",
    "manageScenarioLabel": "Kelola skenario",
    "noLayerMessage": "Harap masukkan setidaknya satu layer di ${tabName}",
    "noEditableLayersAvailable": "Layer harus dicentang sebagai dapat diedit di tab pengaturan layer",
    "updateProjectCostCheckboxLabel": "Perbarui persamaan proyek",
    "updateProjectCostEquationHint": "Petunjuk: Ini akan memungkinkan pengguna untuk memperbarui rumus biaya aset yang sudah ditambahkan ke proyek yang ada dengan rumus baru yang ditentukan di bawah berdasarkan template fitur, geografi, dan skenario. Jika kombinasi tidak ditemukan, maka ini akan diatur ke rumus biaya default, yaitu geografi dan skenario sebagai 'Tidak Ada'. Jika template fitur dihapus, biaya akan diatur sebagai 0."
  },
  "statisticsSettings": {
    "tabTitle": "Pengaturan tambahan",
  ...
  "projectCostSettings": {
    "addProjectCostLabel": "Tambahkan Biaya Proyek Tambahan",
    "additionalCostValueColumnHeader": "Nilai",
    "invalidProjectCostMessage": "Entri Tidak Valid untuk biaya proyek",
    "additionalCostLabelColumnHeader": "Label",
    "additionalCostTypeColumnHeader": "Jenis"
  },
  "statisticsType": {
    "countLabel": "Jumlah",

...
define({
  ...
  "generalSettings": {
    ...
    "csvReportExportLabel": "Tillåt att användare exporterar rapporter för projektet",
    "editReportSettingsBtnTooltip": "Redigera rapportinställningar",
    "roundCostValues": {
    ...
    "reportSettings": {
      "reportSettingsPopupTitle": "Rapportinställningar",
      "reportNameLabel": "Rapportnamn (valfritt) :",
      "checkboxLabel": "Visa",
      "layerTitle": "Titel",
      "columnLabel": "Etikett",
      "duplicateMsg": "Dubblettetikett"
    },
    "projectAreaType": {
      "outline": "Kontur",
      "buffer": "Buffert"
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Polygonlager med följande villkor visas: <br/> <li> Lagret måste ha 'frågekapacitet'</li><li> Lagret måste ha ett GlobalID-fält</li></p>",
    "fieldToLabelGeographyHelp": "<p>Strängfält och numeriska fält i det valda 'geometrilagret för kostnadsberäkningar' visas i listmenyn 'Fält för att namnge geografi'.</p>",
    "projectAssetsTableHelp": "<p>Tabell(er) med följande villkor visas: <br/> <li>Tabellen måste vara redigerbar i form av 'Skapa', 'Ta bort' och 'Uppdatera'</li> <li>Tabellen måste ha sex fält med exakt namn och datatyp:</li><ul><li> AssetGUID (fält av GUID-typ)</li><li> CostEquation (fält av strängtyp)</li><li> Scenario (fält av strängtyp)</li><li> TemplateName (fält av strängtyp)</li><li> GeographyGUID (fält av GUID-typ)</li><li> ProjectGUID (fält av GUID-typ)</li></ul> </p>",
    "projectMultiplierTableHelp": "<p>Tabell(er) med följande villkor visas: <br/> <li>Tabellen måste vara redigerbar i form av 'Skapa', 'Ta bort' och 'Uppdatera'</li> <li>Tabellen måste ha fem fält med exakt namn och datatyp:</li><ul><li> Description (fält av strängtyp)</li><li> Type (fält av strängtyp)</li><li> Value (fält av float/double-typ)</li><li> Costindex (fält av heltalstyp)</li><li> ProjectGUID (fält av GUID-typ))</li></ul> </p>",
    "projectLayerHelp": "<p>Polygonlager med följande villkor visas: <br/> <li>Lagret måste vara redigerbart i form av 'Skapa', 'Ta bort' och 'Uppdatera'</li> <li>Lagret måste ha fem fält med exakt namn och datatyp:</li><ul><li>ProjectName (fält av strängtyp)</li><li>Description (fält av strängtyp)</li><li>Totalassetcost (fält av float/double-typ)</li><li>Grossprojectcost (fält av float/double-typ)</li><li>GlobalID (fält av GlobalID-typ)</li></ul> </p>",
    "pointLayerCentroidLabel": "Punktlagercentroid",
    "selectRelatedPointLayerDefaultOption": "Välj",
    "pointLayerHintText": "<p>Punktlager med följande villkor visas: <br/> <li>\tLagret måste ha fältet Projectid (typ GUID)</li><li>\tLagret måste ha redigeringsmöjlighet, nämligen Skapa, Ta bort och Uppdatera</li></p>"
  },
  "layerSettings": {
    ...
    "create": "Skapa",
    "update": "Uppdatera",
    "deleteColumnLabel": "Ta bort",
    "attributeSettingHeaderTitle": "Attributinställningar",
    "addFieldLabelTitle": "Lägg till attribut",
    "layerAttributesHeaderTitle": "Lagerattribut",
    "projectLayerAttributesHeaderTitle": "Projektlagerattribut",
    "attributeSettingsPopupTitle": "Inställningar för Lagerattribut"
  },
  "costingInfo": {
    ...
    "updateProjectCostCheckboxLabel": "Uppdatera projektekvationer",
  ...
  "statisticsSettings": {
    "tabTitle": "Ytterligare inställningar",
  ...
  "projectCostSettings": {
    "addProjectCostLabel": "Lägg till ytterligare projektkostnad",
    "additionalCostValueColumnHeader": "Värde",
    "invalidProjectCostMessage": "Ogiltig post för projektkostnad",

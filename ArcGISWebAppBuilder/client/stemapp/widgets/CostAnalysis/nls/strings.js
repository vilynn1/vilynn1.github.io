...
define({
  root: ({
    ...
    createLoadProject: {
      ...
      viewInMapLabel: "Preview",
      loadLabel: "Load",
      createLabel: "Create",
      deleteProjectConfirmationMsg: "Are you sure you want to delete the project?",
      noAssetsToViewOnMap: "Selected project doesn't have any assets to view on map.",
      ...
      errorFetchingPointLabel: "Error while fetching label point. Please try again",
      errorAddingPointLabel: "Error while adding label point. Please try again"
    },
    statisticsSettings: {
    ...
    statisticsType: {
      ...
      areaLabel: "Area",
      lengthLabel: "Length",
      expandCollapseAriaLabel: "\'${displayTitle}\' Count '${featureCount}'",
    },
    costingInfo: {
    ...
    workBench: {
      ...
      featureModeText: "Feature Creation Mode",
      sketchToolTitle: "Sketch new assets.",
      selectToolTitle: "Copy assets from existing feature in the map.",
      downloadCSVBtnTitle : "Export Report",
      templatePickerTitle :"Select a template to create new assets:"
    },
    assetDetails: {
    ...
    updateCostEquationPanel: {
      updateProjectCostTabLabel: "Update project equations",
      updateProjectCostSelectProjectTitle: "Select all projects",
      updateButtonTextForm: "Update",
      updateProjectCostSuccess: "Cost equations of the selected projects are updated",
      updateProjectCostError: "Unable to update cost equation of selected projects",
      updateProjectNoProject: "No project found"
    }
  }),
  "ar": 1,
  "bg": 1,

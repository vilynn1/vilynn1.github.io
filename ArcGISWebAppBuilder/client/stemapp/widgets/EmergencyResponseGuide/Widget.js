  ...
  function (
    ...
    return declare([BaseWidget, dijitWidgetBase, dijitWidgetsInTemplate], {
      ...
      postCreate: function () {
        ...
        this.windDirection.invalidMessage = this.nls.invalidNumberMessage;
        this.windDirection.rangeMessage = this.nls.invalidRangeMessage;

        this.addERGNameArea.invalidMessage = this.nls.invalidERGLayerName;
        this.addERGNameArea.missingMessage = this.nls.missingLayerNameMessage;
        ...
        this._setFirstLastFocusableNodes(true);
      },
      ...
      startup: function () {
        ...
        this._materialsData = dojoJSON.parse(materials);
        ...
        var options = {
          ...
          list: {
            ...
            onChooseEvent: lang.hitch(this, function () {
              ...
              if (messagePopup) {
                this.own(on(query(".jimu-btn", messagePopup.domNode)[0], 'keydown',
                ...
                this.own(on(messagePopup.domNode, 'keydown', lang.hitch(this, function (evt) {
      ...
      _handleClickEvents: function () {
        ...
        this.own(on(this.ClearERGButton, 'click', lang.hitch(this, function () {
          ...
          this.spillTime.set("value", "DY");
          this.spillSize.set("value", "SM");
        })));
        ...
        this.own(on(this.resultsPanelBackButton, "click", lang.hitch(this, function () {
          ...
          this._showPanel(this._lastOpenPanel);
          if (this.addERGNameArea.get("value").length === 0) {
        ...
        this.own(on(this.ERGAreaBySizePublishERGButton, 'click', lang.hitch(this, function () {
          ...
          var params = {
            name: (this.publishNewLayer.checked) ? this.addERGNameArea.value : this.featureLayerList.getValue(),
            url: "",
            itemId: "",
            serviceItemId: ""
          };
      ...
      _showPanel: function (currentPanel) {
        ...
        if (currentPanel === 'resultsPage' && !this.isOnScreen) {
          this.resize();
        }
      },
      ...
      _CreateERGButtonClicked: function () {
        if (this._selectedMaterial && this.inputControl.getMapCoordinateDD()) {
          ...
          if (this._selectedMaterial.BLEVE || !this._selectedMaterial.SM_DY) {
            //BLEVE values and materials without SM_DY values do not have any PA distances
            ...
            portalutils.isNameAvailable(checkServiceNameUrl, token,
              ...
              if (response0.available) {
                ...
                portalutils.createFeatureService(createServiceUrl, token,
                  ...
                  this.busyIndicator.hide();
                  this.publishMessage.innerHTML =
                    utils.sanitizeHTML(this.nls.createService.format(err1.message));
                  this._setFirstLastFocusableNodes();
                }));
              } else {
      ...
      _moveMap: function () {
        ...
        startExtent.xmin = this.map.extent.xmin + 0.0005;
      ...
      _setFirstLastFocusableNodes: function (useIsAutoFocusFirstNodeWidget) {
      ...
      _convertValue: function (dist) {
        var convertedValue = (this.defaultUnits === 'feet') ? dojoNumber.parse(dist) * 3.28084 : dist;
        convertedValue = dojoNumber.format(convertedValue, {
          places: 2,
          locale: dojoKernel.locale
        });
        convertedValue = (this.defaultUnits === 'feet') ? convertedValue + " " + this.nls.common.feetAbbr :
          convertedValue + " " + this.nls.common.metersAbbr;
        return convertedValue;
      },

      /**
       * This function is used to get default unit
       */
      _getDefaultUnit: function () {
        var portalUnit, portal;
        if (this.config.erg.hasOwnProperty("unit") && this.config.erg.unit !== "") {
          this.defaultUnits = this.config.erg.unit;
        } else {
          //For backward
          portal = jimuPortalUtils.getPortal(this.appConfig.portalUrl);
          ...
          if (portal && portal.user && portal.user.units) {
            portalUnit = portal.user.units;
          } else {
            portalUnit = portal.units;
          }
          if (portalUnit === "metric") {
            this.defaultUnits = "meters";
          } else {

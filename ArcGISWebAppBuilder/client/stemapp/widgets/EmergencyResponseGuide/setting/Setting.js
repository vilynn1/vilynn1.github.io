...
define([
  ...
  function (
    ...
    utils, BaseWidgetSetting, LayerStructure, symbologySettings, jimuPortalUtils) {
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      startup: function () {
        ...
        if (this.config.erg.hasOwnProperty("unit") && this.config.erg.unit !== "") {
          this._setSelectedOption(this.defaultUnit, this.config.erg.unit);
        } else {
          //For backward
          this._setSelectedOption(this.defaultUnit, this._getPortalUnit());
        }
      },
      ...
      getConfig: function () {
        ...
        this.config.erg.unit = this.defaultUnit.value;
       ...
       */
      _getPortalUnit: function () {
        var defaultUnits, portalUnit;

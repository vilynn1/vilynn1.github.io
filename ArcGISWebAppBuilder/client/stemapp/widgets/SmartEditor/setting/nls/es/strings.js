define({
  "layersPage": {
    ...
    "customSettingsRadioBtnLabel": "Configuración personalizada",
    ...
    "editDescription": "Escribir texto para que se muestre en el panel de edición",
    ...
    "promptOnSaveTip": "Muestra una solicitud cuando la entidad actual tiene ediciones sin guardar. (Al copiar varias entidades, estas se guardan automáticamente.)",
    ...
    "createNewFeaturesFromExisting": "Permite crear nuevas entidades a partir de entidades existentes",
    ...
    "copiedFeaturesOverrideDefaults": "Los valores de las entidades copiadas invalidan los valores predeterminados en los campos de destino",
    ...
    "enableAttributeUpdates": "Mostrar el botón de actualización de Acciones de atributo",
    ...
    "enableValuePicker": "Habilitar selector de valor de intersección",
    ...
    "pixelsToleranecErrorMsg": "Valor de tolerancia de píxeles predeterminados no válido",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "Configurar acciones inteligentes para adjuntos",
    "smartAttachmentPopupTitle": "Configurar acciones inteligentes para adjuntos en <b>${layername}</b>",
    "noDisplayFieldWarningMsg": "Seleccione al menos un campo de visualización para la capa ${layerName}",
    "fieldsSettingsTable": {
      "display": "Vista",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Configurar acciones inteligentes para <b>${fieldname}</b>",
    ...
    "expandAllLabel": "Expandir todas las capas",
    "selectAllLabel": "Seleccionar todos los campos",
    "domainListTitle": "Campos de dominio",
    "noValidFieldTypeMsg": "No hay ninguna capa adecuada disponible en el mapa para este tipo de datos",
  ...
  "filterPage": {
    "submitHidden": "Enviar datos de atributos de campos incluso cuando están ocultos",
    ...
    "noFilterTip": "Con las herramientas anteriores, defina la sentencia para los casos en los que la acción esté activa."
  },
  "geocoderPage": {
  ...
  "presetPage": {
    ...
    "showOnlyDomainFields": "Mostrar solo campos de dominio",
    "hideInPresetDisplay": "Ocultar en visualización de valores predefinidos",
  ...
  "intersectionPage": {
    ...
    "intersectingLayersLabel": "Capas para extraer un valor",
    ...
    "intersectionLayerHint": "La clasificación de capa se determina en orden descendente. Utilice las flechas en Acciones para reordenar las capas y cambiar la prioridad de intersección."
  },
  "presetAll": {
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Nota: los campos de esta capa se utilizan para definir los criterios de expresión. 'Capa y campos en los que aplicar' solo muestra capas y tablas que tienen campos definidos en la expresión.",
    "expressionText": "Expresión",
    "editExpressionLabel": "Editar expresión",
    "layerAndFieldsApplyLabel": "Capa y campos en los que aplicar",
    "submitAttributeText": "Enviar datos de atributos de campos incluso cuando están ocultos",
    ...
    "deleteGroupPopupMsg": "Al eliminar este grupo se eliminará esta expresión de todos los campos asociados.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Al eliminar este grupo se eliminará la acción de atributos de todos los campos asociados.",
    "alreadyAppliedActionMsg": "Se ha aplicado la acción ${action} en este campo en el grupo",
    "alreadyAppliedActionLayerMsg": "Se ha aplicado la acción ${action} en este campo desde la Configuración de capa",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "Este grupo no tiene campos asociados.",
    "presetNoFieldWarningMsg": "Configure al menos un campo para el grupo predefinido: ${groupName}"
  },
  "chooseFromLayer": {
    "fieldLabel": "Campo",
    "valueLabel": "Valor",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Campos de dominio seleccionados: ${domainFields}",
    "selectDefaultDomainMsg": "Seleccione un dominio de valores predeterminados o asegúrese de que la casilla de verificación del dominio predeterminado seleccionado esté activada"
  },

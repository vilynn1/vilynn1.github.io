define({
  "layersPage": {
    ...
    "removeOnSaveTip": "Opção para remover o elemento do conjunto de seleção quando o registo é guardado. Caso seja o único registo selecionado, o painel regressa à página do modelo.",
    ...
    "copiedFeaturesOverrideDefaultsTip": "Os valores de elementos copiados substituem os valores do modelo predefinido apenas para os campos correspondentes",
  ...
  "smartActionsPage": {
    ...
    "deleteGroupPopupMsg": "Eliminar este grupo faz com que esta expressão seja removida de todos os campos associados.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Eliminar este grupo faz com que a ação de atributo seja removida de todos os campos associados.",

define({
  "layersPage": {
    ...
    "removeOnSaveTip": "Alternativ for å fjerne geoobjektet fra utvalgssettet når posten lagres. Hvis posten er den eneste valgte posten, går panelet tilbake til å vise malsiden.",
    ...
    "createNewFeaturesFromExisting": "Tillat oppretting av nye geoobjekter fra eksisterende geoobjekter",
    ...
    "copiedFeaturesOverrideDefaults": "Verdier fra kopierte geoobjekter overstyrer standardverdier i målfelt",
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Merk: Dette lagets felter vil bli brukt til å definere kriterier for uttrykket. «Lag og felt å brukes på» viser bare lag og tabeller som har feltene definert i uttrykket.",
    "expressionText": "Uttrykk",
    "editExpressionLabel": "Rediger uttrykk",
    "layerAndFieldsApplyLabel": "Lag og felt å brukes på",
    ...
    "deleteGroupPopupMsg": "Sletting av denne gruppen medfører at uttrykket fjernes fra alle de tilknyttede feltene.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Sletting av denne gruppen medfører at attributthandlingen fjernes fra alle de tilknyttede feltene.",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Valgte domenefelt: ${domainFields}",

define({
  "layersPage": {
    ...
    "removeOnSaveTip": "Đã thiết lập tùy chọn cho phép xóa đối tượng khỏi lựa chọn khi lưu bản ghi. Nếu đó là bản ghi duy nhất được chọn, bảng điều khiển được chuyển trở về trang biểu mẫu.",
    ...
    "copiedFeaturesOverrideDefaults": "Các giá trị từ đối tượng được sao chép ghi đè lên các giá trị mặc định trong các trường đích",
  ...
  "intersectionPage": {
    ...
    "intersectingLayersLabel": "Các lớp cần trích xuất giá trị",
    "layerAndFieldsApplyLabel": "Các lớp và trường cần áp dụng giá trị đã trích xuất",
  ...
  "smartActionsPage": {
    ...
    "layerAndFieldsApplyLabel": "Các lớp và trường được áp dụng",
    ...
    "deleteGroupPopupMsg": "Thao tác xóa nhóm này sẽ dẫn đến kết quả xóa biểu thức này trong tất cả trường được liên kết.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Thao tác xóa nhóm này sẽ dẫn đến kết quả xóa hành động thuộc tính trong tất cả trường được liên kết.",

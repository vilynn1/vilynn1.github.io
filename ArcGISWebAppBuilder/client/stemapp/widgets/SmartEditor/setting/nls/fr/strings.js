define({
  "layersPage": {
    ...
    "customSettingsRadioBtnLabel": "Paramètres personnalisés",
    ...
    "promptOnSave": "Demander l’enregistrement des modifications non enregistrées lors de la fermeture du formulaire ou lors du passage à l’enregistrement suivant",
    "promptOnSaveTip": "Afficher une invite lorsque l’entité actuelle comporte des modifications non enregistrées. (La copie de plusieurs entités est enregistrée automatiquement.)",
    "promptOnDelete": "Demander une confirmation lors de la suppression d’un enregistrement",
    "promptOnDeleteTip": "Afficher une invite lorsque l’utilisateur clique sur Supprimer pour confirmer l’action.",
    "removeOnSave": "Supprimer l’entité de la sélection lors de l’enregistrement",
    "removeOnSaveTip": "Option permettant de supprimer l’entité de l’ensemble de sélection lors de la sauvegarde de l’enregistrement. S’il s’agit du seul enregistrement sélectionné, la fenêtre revient sur la page du modèle.",
    ...
    "enableAttributeUpdates": "Afficher le bouton de mise à jour Actions sur les attributs",
    ...
    "enableValuePicker": "Activer le sélecteur de valeurs d’intersection",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "Configurer des actions intelligentes pour les pièces jointes",
    "smartAttachmentPopupTitle": "Configurer des actions intelligentes pour les pièces jointes dans <b>${layername}</b>",
    "noDisplayFieldWarningMsg": "Sélectionnez au moins un champ d’affichage pour la couche ${layerName}",
    "fieldsSettingsTable": {
      "display": "Affichage",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Configurer des actions intelligentes pour <b>${fieldname}</b>",
    ...
    "selectAllLabel": "Sélectionner tous les champs",
    "domainListTitle": "Champs de domaine",
    "noValidFieldTypeMsg": "Aucune couche appropriée n’est disponible sur la carte pour ce type de données",
  ...
  "filterPage": {
    ...
    "noFilterTip": "À l’aide des outils ci-dessus, définissez l’instruction indiquant la période d’activité de l’action."
  },
  "geocoderPage": {
  ...
  "intersectionPage": {
    ...
    "intersectionLayerHint": "Le classement des couches est défini dans l’ordre décroissant. Utilisez les flèches sous Actions pour réorganiser les couches et modifier la priorité des intersections."
  },
  "presetAll": {
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Remarque : les champs de cette couche sont utilisés pour définir les critères d’expression. L’option 'Couches et champs d’application' affiche uniquement les couches et tables dont les champs sont définis dans l’expression.",
    ...
    "deleteGroupPopupMsg": "La suppression de ce groupe entraîne la suppression de cette expression pour tous les champs associés.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "La suppression de ce groupe entraîne la suppression de l’action sur les attributs pour tous les champs associés.",
    "alreadyAppliedActionMsg": "Action ${action} appliquée à ce champ dans le groupe",
    "alreadyAppliedActionLayerMsg": "Action ${action} appliquée à ce champ à partir des paramètres de la couche",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "Aucun champ n’est associé à ce groupe.",
    "presetNoFieldWarningMsg": "Configurez au moins un champ pour le groupe prédéfini ${groupName}"
  },
  "chooseFromLayer": {
    "fieldLabel": "Champ",
    "valueLabel": "Valeur",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Champs de domaine sélectionnés : ${domainFields}",

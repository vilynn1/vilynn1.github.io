define({
  "layersPage": {
    ...
    "customSettingsRadioBtnLabel": "Impostazioni personalizzate",
    ...
    "promptOnSaveTip": "Visualizzare un prompt quando la feature corrente contiene modifiche non salvate. (Salvataggio automatico copiando diverse feature.)",
    ...
    "removeOnSave": "Rimuovere la feature dalla selezione al salvataggio",
    ...
    "copiedFeaturesOverrideDefaults": "I valori dalle feature copiate sovrascrivono i valori predefiniti nei campi di destinazione",
    ...
    "enableAttributeUpdates": "Mostrare il pulsante di aggiornamento delle azioni attributo",
    ...
    "enableValuePicker": "Abilitare il selettore del valore di intersezione",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "Configurare le azioni smart per gli allegati",
    "smartAttachmentPopupTitle": "Configurare le azioni smart per gli allegati in <b>${layername}</b>",
    "noDisplayFieldWarningMsg": "Selezionare almeno un campo di visualizzazione per il layer ${layerName}",
    "fieldsSettingsTable": {
      "display": "Visualizza",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Configura azioni smart per <b>${fieldname}</b>",
    ...
    "selectAllLabel": "Seleziona tutti i campi",
    "domainListTitle": "Campi del dominio",
    "noValidFieldTypeMsg": "Nessun layer appropriato disponibile nella mappa per questo tipo di dati",
  ...
  "filterPage": {
    ...
    "noFilterTip": "Utilizzando gli strumenti precedenti, definire l'istruzione per quando l'azione è attiva."
  },
  "geocoderPage": {
  ...
  "intersectionPage": {
    ...
    "intersectingLayersLabel": "Layer da cui estrarre un valore",
    "layerAndFieldsApplyLabel": "Layer e campi su cui applicare il valore estratto",
    ...
    "intersectionLayerHint": "La classificazione dei layer viene stabilita in ordine decrescente. Utilizzare le frecce sotto alle Azione per riordinare i layer e cambiare la priorità di intersezione."
  },
  "presetAll": {
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Nota: i campi di questo layer vengono utilizzati per definire i criteri di espressione. \"Layer e campi da applicare su\" visualizza solo i layer e le tabelle i cui campi sono definiti nell'espressione.",
    ...
    "deleteGroupPopupMsg": "Eliminando questo gruppo verrà rimossa questa espressione da tutti i campi associati.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Eliminando questo gruppo verrà rimossa l'azione dell'attributo per tutti i campi associati.",
    "alreadyAppliedActionMsg": "Azione ${action} applicata su questo campo in gruppo",
    "alreadyAppliedActionLayerMsg": "Azione ${action} applicata su questo campo dalle impostazioni layer",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "Questo gruppo non include campi associati.",
    "presetNoFieldWarningMsg": "Configurare almeno un campo per il gruppo preimpostato: ${groupName}"
  },
  "chooseFromLayer": {
    "fieldLabel": "Campo",
    "valueLabel": "Valore",

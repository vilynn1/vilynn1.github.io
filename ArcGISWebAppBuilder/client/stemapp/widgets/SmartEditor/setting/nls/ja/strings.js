define({
  "layersPage": {
    ...
    "customSettingsRadioBtnLabel": "カスタム設定",
    "smartActionsTabTitle": "スマート アクション",
    "attributeActionsTabTitle": "属性アクション",
    "geocoderSettingsText": "ジオコーダーの設定",
    "editDescription": "編集パーセルに表示するテキストを指定",
    "editDescriptionTip": "このテキストは、[テンプレート] ピッカーの上に表示されます。テキストがない場合は、空白のままにしてください。",
    "promptOnSave": "フォームが閉じられたか、次のレコードに切り替えられた場合に、保存されていない編集内容を保存するプロンプト",
    "promptOnSaveTip": "現在のフィーチャに保存されていない編集内容がある場合、プロンプトを表示します。 (複数フィーチャをコピーすると、自動的に保存処理が実行されます)。",
    ...
    "createNewFeaturesFromExisting": "既存のフィーチャからの新規フィーチャの作成の許可",
    "createNewFeaturesFromExistingTip": "ユーザーが既存のフィーチャをコピーして新しいフィーチャを作成できるようにするオプション",
    "copiedFeaturesOverrideDefaults": "コピーされたフィーチャの値は、ターゲット フィールドのデフォルト値を上書きします",
    "copiedFeaturesOverrideDefaultsTip": "コピーされたフィーチャの値は、一致したフィールドのデフォルト テンプレートの値のみを上書きします",
    ...
    "enableAttributeUpdates": "属性アクションの更新ボタンを表示",
    ...
    "pixelsToleranecErrorMsg": "無効なデフォルトのピクセル許容値",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "アタッチメントに対するスマート アクションの構成",
    "smartAttachmentPopupTitle": "<b>${layername}</b> におけるアタッチメントに対するスマート アクションの構成",
    "noDisplayFieldWarningMsg": "レイヤー ${layerName} について、少なくとも 1 つの表示フィールドを選択してください。",
    "fieldsSettingsTable": {
      "display": "表示",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "</b>${fieldname}<b> のスマート アクションの構成",
    ...
    "expandAllLabel": "すべてのレイヤーを展開",
    "selectAllLabel": "すべてのフィールドを選択",
    "domainListTitle": "ドメイン フィールド",
    "noValidFieldTypeMsg": "このデータ タイプには、マップで利用できる適切なレイヤーがありません",
  ...
  "presetPage": {
    ...
    "showOnlyDomainFields": "ドメイン フィールドのみを表示",
    "hideInPresetDisplay": "設定済みの値の表示から削除",
  ...
  "intersectionPage": {
    ...
    "noLayersMessage": "選択したデータ タイプと一致するフィールドがマップ レイヤー内に見つかりませんでした。",
    "intersectionLayerHint": "レイヤーのランキングは降順で決定されます。 [アクション] の下の矢印を選択して、レイヤーの順序および交点の優先順位を変更します。"
  },
  "presetAll": {
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "注: このレイヤーのフィールドは、式の条件定義に使用されます。 適用されるレイヤーとフィールドでは、式で定義したフィールドを持つレイヤーとテーブルだけが表示されます。",
    "expressionText": "条件式",
    "editExpressionLabel": "条件式の編集",
    "layerAndFieldsApplyLabel": "適用されるレイヤーとフィールド",
    "submitAttributeText": "フィールドの属性データを非表示の場合でも送信",
    ...
    "deleteGroupPopupMsg": "このグループを削除すると、関連するすべてのフィールドのこの式が削除されます。",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "このグループを削除すると、関連するすべてのフィールドの属性アクションが削除されます。",
    "alreadyAppliedActionMsg": "グループのこのフィールドに適用されている ${action} アクション",
    "alreadyAppliedActionLayerMsg": "レイヤー設定からこのフィールドに適用されている ${action} アクション",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "このグループには、関連付けられたフィールドがありません。",
    "presetNoFieldWarningMsg": "現在のグループ: ${groupName} に対しついてフィールドを少なくとも 1 つ構成してください。"
  },
  "chooseFromLayer": {
    "fieldLabel": "フィールド",
    "valueLabel": "値",
  ...
  "relativeDomains": {
    ...
    "valueText": "値",
    "defaultText": "デフォルト値",
    "selectedDomainFieldsHint": "選択したドメイン フィールド: ${domainFields}",
    "selectDefaultDomainMsg": "デフォルト値のドメインを選択するか、選択したデフォルト ドメインのチェックボックスがオンであることを確認してください"
  },

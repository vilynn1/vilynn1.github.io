define({
  "layersPage": {
    ...
    "copiedFeaturesOverrideDefaults": "Kopyalanan detayların değerleri hedef alanlardaki varsayılan değerleri geçersiz kılar",
  ...
  "smartActionsPage": {
    ...
    "deleteGroupPopupMsg": "Bu grubun silinmesi, ifadenin tüm ilişkili alanlardan kaldırılmasıyla sonuçlanır.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Bu grubun silinmesi, öznitelik eyleminin tüm ilişkili alanlardan kaldırılmasıyla sonuçlanır.",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Seçili domain alanları: ${domainFields}",

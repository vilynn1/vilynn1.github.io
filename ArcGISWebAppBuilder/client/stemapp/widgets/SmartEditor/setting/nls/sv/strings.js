define({
  "layersPage": {
    ...
    "customSettingsRadioBtnLabel": "Anpassade inställningar",
    ...
    "editDescription": "Ange text som ska visas för redigeringspanelen",
    ...
    "promptOnSaveTip": "Visa en uppmaning om det finns ändringar som inte har sparats i det aktuella geoobjektet. (När flera geoobjekt kopieras sparas de automatiskt.)",
    ...
    "enableAttributeUpdates": "Visa uppdateringsknappen Attributåtgärder",
    "enableAutomaticAttributeUpdates": "Anropa attributåtgärderna automatiskt efter uppdatering av geometrin",
    ...
    "enableValuePicker": "Aktivera väljare för korsningsvärde",
    ...
    "pixelsToleranecErrorMsg": "Ogiltigt värde för Tolerans för standardpixlar",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "Konfigurera smarta åtgärder för bilagor",
    "smartAttachmentPopupTitle": "Konfigurera smarta åtgärder för bilagor i <b>${layername}</b>",
    "noDisplayFieldWarningMsg": "Välj minst ett visningsfält för lagret ${layerName}",
    "fieldsSettingsTable": {
      "display": "Visa",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Konfigurera smarta åtgärder för <b>${fieldname}</b>",
    ...
    "copyAttributesNote": "Om du inaktiverar en åtgärd med ett gruppnamn är det samma sak som att redigera åtgärden fristående. Åtgärden för det här fältet kommer att tas bort från respektive grupp.",
    "searchPlaceHolder": "Sök",
    "expandAllLabel": "Expandera alla lager",
    "selectAllLabel": "Välj alla fält",
    "domainListTitle": "Domänfält",
    "noValidFieldTypeMsg": "Det finns inget lämpligt lager tillgängligt i kartan för den här datatypen",
    ...
    "editOptionsPopup": {
      ...
      "editAttributeGroup": "Den valda attributåtgärden anges från gruppen. Välj ett av följande alternativ för att redigera attributåtgärden:",
      "expression": "Uttrycket för den valda smarta åtgärden anges från gruppen. Välj ett av följande alternativ för att redigera uttryck för den smarta åtgärden:",
      "editGroupButton": "Redigera grupp",
      "editIndependentlyButton": "Redigera fristående"
    }
  },
  "filterPage": {
    "submitHidden": "Skicka attributdata för fält även om de är dolda",
    ...
    "noFilterTip": "Använd verktygen ovan för att definiera påståendet för när åtgärden är aktiv."
  },
  "geocoderPage": {
  ...
  "presetPage": {
    ...
    "showOnlyDomainFields": "Visa endast domänfält",
    "hideInPresetDisplay": "Dölj i visningen av förinställda värden",
  ...
  "intersectionPage": {
    ...
    "pixelsUnitText": "Pixlar",
    "useLayerName": "– Använd lagernamn –",
    "noLayersMessage": "Inget fält hittades i kartlager som matchar den valda datatypen.",
    "intersectionLayerHint": "Rangordningslager fastställs i fallande ordning. Använd pilarna under Åtgärder för att ändra lagerordningen och korsningsprioriteten."
  },
  "presetAll": {
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Observera: Det här lagrets fält används för att definiera uttryckets villkor. 'Lager och fält för användning' visar bara lager och tabeller som har fält definierade i uttrycket.",
    "expressionText": "Uttryck",
    "editExpressionLabel": "Redigera uttryck",
    "layerAndFieldsApplyLabel": "Lager och fält för användning",
    "submitAttributeText": "Skicka attributdata för fält även om de är dolda",
    ...
    "deleteGroupPopupMsg": "Om gruppen tas bort kommer uttrycket att tas bort från alla kopplade fält.",
  ...
  "attributeActionsPage": {
    ...
    "alreadyAppliedActionMsg": "Åtgärden ${action} har redan använts på det här fältet i gruppen",
    "alreadyAppliedActionLayerMsg": "Åtgärden ${action} har redan använts på det här fältet från lagerinställningarna",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "Gruppen har inga associerade fält.",
    "presetNoFieldWarningMsg": "Konfigurera minst ett fält för den förinställda gruppen: ${groupName}"
  },
  "chooseFromLayer": {
    "fieldLabel": "Fält",
    "valueLabel": "Värde",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Valda domänfält: ${domainFields}",
    "selectDefaultDomainMsg": "Välj en standardvärdedomän eller kontrollera att kryssrutan för den valda standarddomänen är markerad"
  },

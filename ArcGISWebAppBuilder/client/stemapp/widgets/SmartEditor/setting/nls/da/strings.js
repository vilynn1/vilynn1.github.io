define({
  "layersPage": {
    ...
    "customSettingsRadioBtnLabel": "Brugerdefinerede indstillinger",
    ...
    "editDescription": "Angiv tekst, der skal vises, til redigeringspanelet",
    ...
    "promptOnSaveTip": "Vis en prompt, når det aktuelle objekt har ændringer, der ikke er gemt. (Ved kopiering af flere objekter gemmes der automatisk).",
    "promptOnDelete": "Bed om bekræftelse, når der slettes en post.",
    ...
    "createNewFeaturesFromExisting": "Gør det muligt at oprette nye objekt ud fra eksisterende objekter",
    ...
    "copiedFeaturesOverrideDefaults": "Værdier fra kopierede objekter tilsidesætter standardværdier i målfelter",
    "copiedFeaturesOverrideDefaultsTip": "Værdier fra kopierede objekter vil kun tilsidesætte standard-skabelonværdier for de matchede felter",
    ...
    "enableAttributeUpdates": "Vis opdateringsknappen Attributhandlinger",
    "enableAutomaticAttributeUpdates": "Kalder automatiske attributhandlinger efter opdatering af geometri",
    ...
    "enableValuePicker": "Aktiver værdivælger ved gennemskæring",
    ...
    "pixelsToleranecErrorMsg": "Ugyldig toleranceværdi for standardpixels",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "Konfigurér smarte handlinger for vedhæftninger",
    "smartAttachmentPopupTitle": "Konfigurér smarte handlinger for vedhæftninger i <b>${layername}</b>",
    "noDisplayFieldWarningMsg": "Vælg mindst ét visningsfelt for laget ${layerName}",
    "fieldsSettingsTable": {
      "display": "Visning",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Konfigurér smarte handlinger for <b>${fieldname}</b>",
    ...
    "selectAllLabel": "Vælg alle felter",
    "domainListTitle": "Domænefelter",
    "noValidFieldTypeMsg": "Der er ikke noget passende lag tilgængeligt i kortet for denne datatype.",
    ...
    "editOptionsPopup": {
      ...
      "editAttributeGroup": "Den valgte attributhandling er defineret fra gruppen. Vælg en af følgende indstillinger for at redigere attributhandlingerne:",
  ...
  "filterPage": {
    "submitHidden": "Send attributdata for felter, også når de er skjult",
    ...
    "noFilterTip": "Definér erklæringen for, hvornår handlingen er aktiv, ved hjælp af værktøjerne ovenfor."
  },
  "geocoderPage": {
  ...
  "intersectionPage": {
    ...
    "layerAndFieldsApplyLabel": "Lag og felter for at anvende den udtrukne værdi",
    ...
    "noLayersMessage": "Der blev ikke fundet noget felt i de lag i kortet, der matcher den valgte datatype.",
    "intersectionLayerHint": "Rangordning af lag bestemmes i faldende rækkefølge. Brug pilene under Handlinger til at ændre lag-rækkefølgen og prioriteringen af skæringspunkter."
  },
  "presetAll": {
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Bemærk: Dette lags felter vil blive anvendt til at definere udtrykskriterier. 'Lag og felter, der anvendes til' viser kun lag og tabeller, der har felterne defineret i Udtrykket.",
    "expressionText": "Udtryk",
    "editExpressionLabel": "Redigér udtryk",
    "layerAndFieldsApplyLabel": "Lag og felter, der anvendes til",
    "submitAttributeText": "Send attributdata for felter, også når de er skjult",
    ...
    "deleteGroupPopupMsg": "Sletning af gruppen vil resultere i, at udtrykket fjernes fra alle tilknyttede felter.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Sletning af denne gruppe vil resultere i, at attributhandlingen fjernes fra alle tilknyttede felter.",
    "alreadyAppliedActionMsg": "Handlingen ${action} anvendes til dette felt i gruppen",
    "alreadyAppliedActionLayerMsg": "Handlingen ${action} anvendes til dette felt fra Lag-indstillinger",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "Denne gruppe har ingen tilknyttede felter.",
    "presetNoFieldWarningMsg": "Konfigurér mindst et felt til den forudindstillede gruppe: ${groupName}"
  },
  "chooseFromLayer": {
    "fieldLabel": "Felt",
    "valueLabel": "Værdi",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Valgte domænefelter: ${domainFields}",

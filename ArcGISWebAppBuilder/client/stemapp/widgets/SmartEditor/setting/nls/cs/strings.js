define({
  "layersPage": {
    ...
    "title": "Vyberte šablonu, pomocí níž chcete vytvářet prvky nebo klikněte na prvek v mapě pro jeho úpravu",
    "generalSettings": "Obecná nastavení",
    "layerSettings": "Nastavení vrstvy",
    "webmapSettingsRadioBtnLabel": "Zohlednit nastavení webové mapy",
    "customSettingsRadioBtnLabel": "Vlastní nastavení",
    ...
    "promptOnSaveTip": "Zobrazí výzvu, pokud aktuální prvek obsahuje neuložené změny. (Kopírování více prvků, které se ukládají automaticky.)",
    ...
    "copiedFeaturesOverrideDefaults": "Hodnoty z kopírovaných prvků přepíší výchozí hodnoty v cílových polích",
    ...
    "editLayerAddedFromAddData": "Povolit editaci vrstev přidaných z widgetu Přidat data",
    "editLayerAddedFromAddDataTip": "Upravitelné vrstvy přidané do aplikace pomocí widgetu Přidat data lze editovat",
    ...
    "enableAttributeUpdates": "Zobrazit tlačítko aktualizace Akcí atributů",
    ...
    "enableValuePicker": "Povolit výběr hodnoty průsečíku",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "Konfigurovat chytré akce pro přílohy",
    "smartAttachmentPopupTitle": "Konfigurovat chytré akce pro přílohy v <b>${layername}</b>",
    "noDisplayFieldWarningMsg": "Vyberte alespoň jedno zobrazovací pole pro vrstvu ${layerName}",
    "fieldsSettingsTable": {
      "display": "Zobrazení",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "Konfigurovat chytré akce pro <b>${fieldname}</b>",
    ...
    "selectAllLabel": "Vybrat všechna pole",
    "domainListTitle": "Pole domény",
    "noValidFieldTypeMsg": "V mapě není k dispozici žádná vhodná vrstva pro tento typ dat.",
  ...
  "filterPage": {
    ...
    "noFilterTip": "Pomocí výše umístěných nástrojů definujte podmínku pro situaci, kdy je akce aktivní."
  },
  "geocoderPage": {
  ...
  "coordinatesPage": {
    ...
    "coordinatesSelectTitle": "Referenční systém",
    ...
    "myLocation": "Moje umístění",
    "LatLong": {
      "y": "Zeměpisná šířka",
      "x": "Zeměpisná délka",
      "xy": "Zeměpisná délka zeměpisná šířka",
      "yx": "Zeměpisná šířka zeměpisná délka"
    },
    "MapSpatialReference": {
      "y": "Y",
      "x": "X",
  ...
  "intersectionPage": {
    ...
    "intersectingLayersLabel": "Vrstvy pro extrakci hodnoty",
    "layerAndFieldsApplyLabel": "Vrstvy a pole pro použití extrahované hodnoty",
    ...
    "intersectionLayerHint": "Pořadí vrstev je stanoveno sestupně. Pomocí šipek v části Akce můžete změnit pořadí vrstev a prioritu průsečíku."
  },
  "presetAll": {
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Poznámka: Pole této vrstvy budou použita pro definování kritérií výrazu. „Vrstvy a pole, na něž má být výraz aplikován“ zobrazí pouze vrstvy a tabulky, které mají pole definovaná ve výrazu.",
    ...
    "deleteGroupPopupMsg": "Odstranění této skupiny bude mít za následek odebrání výrazu ze všech přiřazených akcí polí.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Odstranění této skupiny bude mít za následek odebrání akce atributů ze všech souvisejících polí.",
    "alreadyAppliedActionMsg": "${action} akce byla na toto pole ve skupině aplikována",
    "alreadyAppliedActionLayerMsg": "${action} akce byla na toto pole z Nastavení vrstev aplikována",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "Tato skupina nemá žádná související pole.",
    "presetNoFieldWarningMsg": "Nakonfigurujte alespoň jedno pole pro přednastavenou skupinu : ${groupName}"
  },
  "chooseFromLayer": {
    "fieldLabel": "Pole",
    "valueLabel": "Hodnota",

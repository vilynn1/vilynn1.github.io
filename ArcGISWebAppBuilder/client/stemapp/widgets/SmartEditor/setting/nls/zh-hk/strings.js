define({
  "layersPage": {
    ...
    "enableAttributeUpdates": "顯示「屬性動作」更新按鈕",
    ...
    "pixelsToleranecErrorMsg": "預設的像素容差值無效",
  ...
  "fieldsPage": {
    ...
    "smartAttachmentText": "配置附件的智慧動作",
    "smartAttachmentPopupTitle": "在 <b>${layername}</b> 中配置附件的智慧動作",
    "noDisplayFieldWarningMsg": "請至少為圖層 ${layerName} 選擇一個顯示欄位",
    "fieldsSettingsTable": {
      "display": "顯示",
  ...
  "actionPage": {
    ...
    "smartActionTitle": "配置 <b>${fieldname}</b> 的智慧動作",
    ...
    "selectAllLabel": "選擇所有欄位",
    "domainListTitle": "網域欄位",
    "noValidFieldTypeMsg": "地圖中沒有適用於此資料類型的適合圖層",
  ...
  "intersectionPage": {
    ...
    "pixelsUnitText": "像素",
    "useLayerName": "- 使用圖層名稱 -",
    "noLayersMessage": "在地圖圖層中找不到與所選資料類型相符的欄位。",
    "intersectionLayerHint": "圖層排名是按遞減順序決定。 使用「動作」下的箭頭以重新排序圖層並變更交匯點優先順序。"
  },
  "presetAll": {
    "popupTitle": "定義預設值",
    "deleteTitle": "刪除預設值",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "刪除此群組將移除所有關聯欄位的屬性動作。",
    "alreadyAppliedActionMsg": "已在群組的此欄位上套用 ${action} 動作",
    "alreadyAppliedActionLayerMsg": "已從圖層設定的此欄位上套用 ${action} 動作",
    "appliedGroupName": "${groupName}",
    "noPresetFieldsMsg": "此群組沒有相關欄位。",
    "presetNoFieldWarningMsg": "請為預設群組至少配置一個欄位 : ${groupName}"
  },
  "chooseFromLayer": {
    "fieldLabel": "欄位",
    "valueLabel": "數值",

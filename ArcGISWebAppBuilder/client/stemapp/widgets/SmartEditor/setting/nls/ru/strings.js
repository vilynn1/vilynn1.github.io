define({
  "layersPage": {
    ...
    "createNewFeaturesFromExisting": "Разрешить создание новых пространственных объектов из существующих",
    ...
    "copiedFeaturesOverrideDefaults": "Значения из скопированных объектов переопределяют значения по умолчанию в целевых полях",
  ...
  "intersectionPage": {
    ...
    "intersectingLayersLabel": "Слои для извлечения значений",
  ...
  "smartActionsPage": {
    ...
    "deleteGroupPopupMsg": "Удаление этой группы приведет к удалению этого выражения для всех связанных полей.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Удаление этой группы приведет к удалению действия атрибута для всех связанных полей.",

define({
  "layersPage": {
    ...
    "removeOnSaveTip": "Opció per eliminar l'entitat de la selecció definida en desar el registre. Si és l'únic registre seleccionat, la subfinestra torna a canviar a la pàgina de la plantilla.",
  ...
  "smartActionsPage": {
    ...
    "deleteGroupPopupMsg": "En suprimir aquest grup s'eliminarà aquesta expressió de tots els camps associats.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "En suprimir aquest grup s'eliminarà l'acció d'atribut de tots els camps associats.",

define({
  "layersPage": {
    ...
    "createNewFeaturesFromExisting": "Permitir a criação de novas feições a partir das feições existentes",
    "createNewFeaturesFromExistingTip": "Opção para permitir ao usuário copiar a feição existente para criar novas feições",
    "copiedFeaturesOverrideDefaults": "Os valores das feições copiadas substituem os valores padrão nos campos de destino",
  ...
  "smartActionsPage": {
    ...
    "deleteGroupPopupMsg": "A exclusão deste grupo resultará na remoção desta expressão para todos os campos associados.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "A exclusão deste grupo resultará na remoção da ação de atributo para todos os campos associados.",

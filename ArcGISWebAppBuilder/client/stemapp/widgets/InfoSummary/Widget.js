...
function (BaseWidget,
  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    getFeatures: function (lyrInfo, fields, updateCount) {
      ...
      var _needsGeom = (!lyrInfo.listDisabled && lyrInfo.legendOpen) || this.showAllFeatures ? true : false;
    ...
    _getMapLayerFeatureDef: function(queryTaskFeature, oid, jimuLayerInfo) {
      ...
      return parseInt(oid, 10) > -1 && jimuLayerInfo.layerObject ?
        jimuLayerInfo.layerObject.queryFeatures(q) : Promise.resolve();
    },

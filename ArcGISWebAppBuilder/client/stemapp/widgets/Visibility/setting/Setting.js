...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      var options = [], option;
      var dropDownOptions = ['meters', 'kilometers', 'miles', 'feet', 'yards', 'nauticalMiles'];
    ...
    startup: function () {
      ...
      this.own(on(this.minimumObservableDistance, 'change',
    ...
    minObsRangeKeyWasPressed: function () {
      if (this.minimumObservableDistance.isValid()) {
        this.maximumObservableDistance.constraints.min = Number(this.minimumObservableDistance.value) + 0.001;
        this.maximumObservableDistance.set('value', (this.maximumObservableDistance.value &&
          this.maximumObservableDistance.value > this.minimumObservableDistance.value) ?
          this.maximumObservableDistance.value : Number(this.minimumObservableDistance.value) + 1);
      }
    },
    ...
    getConfig: function () {
      if (!this._symbologySettingsInstance.validInputs()) {
        return false;
      }
    ...
    observableDistanceUnitChanged: function () {
      ...
      if (distanceUnit) {
        ...
        constraints.min = Number(this.minimumObservableDistance.value) + 0.001;

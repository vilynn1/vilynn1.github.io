define({
  "page1": {
    ...
    "selectToolDesc": "Виджет поддерживает три метода для создания выбранного набора записей для обновления. Вы можете выбрать только один из этих методов. Если необходимо использовать несколько методов, создайте новый экземпляр виджета.",
